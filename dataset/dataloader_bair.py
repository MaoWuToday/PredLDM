...
def load_data_bair(batch_size, val_batch_size, data_root, num_workers=4,
    ...
    dataloader_train = DataLoader(train_set, batch_size, shuffle=False, num_workers=num_workers)
...
if __name__ == '__main__':
    dataloader_train, _, dataloader_test = \
        load_data_bair(batch_size=16,
                       val_batch_size=4,
                       # data_root='../../data/',
                       data_root=r'F:\PAM-master\data',
                       num_workers=4,
                       pre_seq_length=4, aft_seq_length=12, in_shape=[2, 3, 64, 64])
