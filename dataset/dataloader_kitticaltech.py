...
def load_data_kitticaltech(batch_size, val_batch_size, data_root, num_workers=4,
    ...
    # dataloader_val = DataLoader(val_set, val_batch_size, shuffle=False, num_workers=num_workers)
...
if __name__ == '__main__':
    dataloader_train, _, dataloader_test = \
        load_data_kitticaltech(batch_size=16,
                  val_batch_size=16,
                  # data_root='../../data/',
                  data_root=r'E:\PAM-master\data',
                  num_workers=0,
