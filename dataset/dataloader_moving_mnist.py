...
def load_data_moving_mnist(batch_size, val_batch_size, data_root, num_workers=4, data_name='mnist',
    ...
    dataloader_vali = DataLoader(test_set, val_batch_size, shuffle=False, num_workers=num_workers)
...
if __name__ == '__main__':
    ...
    dataloader_train, _, dataloader_test = \
        load_data_moving_mnist(batch_size=16,
                  val_batch_size=4,
                  # data_root='../../data/',
