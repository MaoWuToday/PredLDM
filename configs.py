class Configs(object):
    ...
    mode = 'test'         # select from: [train, test, valid(x), travel, create]
    ...
    # sota list: UNet, PredRNN, PredRNNpp, ConvLSTM, MIM(x), ConvLSTMNet, MotionRNN, SimVP, PhyDNet(x), SimVP_aug, SimVPv2, MS2P, MS2Pv2, MS2Pv3, MS2Pv3_tune, PredLDM
    ...
    in_len = 10
    out_len = 10               # check the official setting of hko7.
    ...
    fine_tune = False
    pretrained_model = 'PredLDM_epoch100'
    ...
    log_dir = r'logdir'
    # model_save_dir = r'save_models\hko7'
    model_save_dir = r'save_models\kth'
    # model_save_dir = r'save_models_formal\pretrained'
    test_imgs_save_dir = r'save_results\PredLDM'
    # travel_imgs_save_dir = r'travel_results'
    travel_imgs_save_dir = r'travel_results'
    ourdata_save_dir = r'data\pam\test_PredLDM'
    # domains = ['bair', 'hko7', 'human', 'kitticaltech', 'kth', 'moving_mnist', 'sevir-vil', 'sevir-vis', 'shanghai2020']
    domain = 'kth'

    import os
    if model == 'MS2Pv3_tune' or 'PredLDM':
