...
class EncoderRNN(torch.nn.Module):
    def __init__(self, phycell, convcell, device, channel_num):
        super(EncoderRNN, self).__init__()
        self.encoder_E = encoder_E(nc=channel_num)  # general encoder 64x64x1 -> 32x32x32
        ...
        self.decoder_D = decoder_D(nc=channel_num)  # general decoder 32x32x32 -> 64x64x1
