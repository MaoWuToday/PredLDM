...
class MaskGenerator(nn.Module):
    ...
    def __init__(self, input_size=192, mask_patch_size=32, model_patch_size=4, mask_ratio=0.3):
...
class MS2Pv3(nn.Module):
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
                 mlp_ratio=8., drop=0.5, drop_path=0.5, spatio_kernel_enc=3,
                 spatio_kernel_dec=3, act_inplace=True, **kwargs):
        super(MS2Pv3, self).__init__()
    ...
    def forward(self, x, **kwargs):
        ...
        # siamese decoding
        Y_in = self.dec(embed_lower, skip_lower)
